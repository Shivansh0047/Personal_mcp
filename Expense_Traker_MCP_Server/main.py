...
@mcp.resource("expense://categories", mime_type="application/json") # We are providing this resource to claude, so it will not guess but rather pick form these categories
def categories(): 
